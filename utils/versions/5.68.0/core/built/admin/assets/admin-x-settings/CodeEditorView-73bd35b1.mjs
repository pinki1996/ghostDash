import { b as ke, d as F, b1 as wt, bI as qn, D as Rt, bJ as Hn, j as W, bK as Vn, G as zn, z as Un, X as $n, K as Gn, H as Kn, I as Jn } from "./index-b8520e93.mjs";
import { E as p, F as fe, v as Ee, S as we, o as d, w as qe, C as _n, x as jn, y as Tt, z as It, A as Se, B as Ot, G as Pt, H as Wt, J as $e, K as Ze, M as w, O as Y, g as et, b as Ge, Q as Qn, R as ee, V as Ft, U as y, W as Xn, X as Yn, Y as ce, Z as L, _ as Zn, $ as er, a0 as tt, a1 as he, a2 as tr, a3 as nr, a4 as rr, a5 as or, a6 as ir, a7 as sr, a8 as lr, a9 as ar, aa as cr, ab as hr, ac as ur, ad as fr, ae as dr, af as mr, ag as Nt, ah as gr, ai as pr, aj as yr, ak as xr, al as kr, am as br, an as qt, ao as Sr, ap as Cr, t as f, aq as vr } from "./index-9cc1df42.mjs";
const Ar = (t) => {
...
const Ke = /* @__PURE__ */ Ze.define(), Rr = /* @__PURE__ */ Ze.define(), Tr = /* @__PURE__ */ fe.define(), Vt = /* @__PURE__ */ fe.define({
  combine(t) {
    return Ee(t, {
      minDepth: 100,
      newGroupDelay: 500,
...
const zt = /* @__PURE__ */ we.define({
  ...
  update(t, e) {
    ...
    if (n) {
      let a = e.docChanged ? d.single(Ir(e.changes)) : void 0, c = C.fromTransaction(e, a), h = n.side, u = h == 0 ? t.undone : t.done;
      return c ? u = Ce(u, u.length, r.minDepth, c) : u = Gt(u, e.startState.selection), new I(h == 0 ? n.rest : u, h == 0 ? u : n.rest);
    }
  ...
  fromJSON(t) {
    return new I(t.done.map(C.fromJSON), t.undone.map(C.fromJSON));
  }
});
function Or(t = {}) {
  return [
...
class I {
  ...
  addChanges(e, r, n, o, i) {
    ...
    n == "input.type.compose") ? s = Ce(s, s.length - 1, o.minDepth, new C(e.changes.compose(l.changes), $t(e.effects, l.effects), l.mapped, l.startSelection, D)) : s = Ce(s, s.length, o.minDepth, e), new I(s, D, r, n);
  }
  addSelection(e, r, n, o) {
    let i = this.done.length ? this.done[this.done.length - 1].selectionsAfter : D;
    return i.length > 0 && r - this.prevTime < o && n == this.prevUserEvent && n && /^select($|\.)/.test(n) && Nr(i[i.length - 1], e) ? this : new I(Gt(this.done, e), this.undone, r, n);
  }
  addMapping(e) {
    return new I(He(this.done, e), He(this.undone, e), this.prevTime, this.prevUserEvent);
  }
  pop(e, r, n) {
...
function Ie(t, e, r) {
  ...
  return i && (s = r ? Y(t, n.from, 1) : Y(t, n.to, -1)) && s.matched ? l = r ? s.end.to : s.end.from : l = r ? n.to : n.from, d.cursor(l, r ? -1 : 1);
}
const Jr = (t) => R(t, (e) => Ie(t.state, e, !S(t))), _r = (t) => R(t, (e) => Ie(t.state, e, S(t)));
function Qt(t, e) {
  return R(t, (r) => {
    if (!r.empty)
      return Te(r, e);
...
const jr = (t) => R(t, (e) => q(t, e, !0)), Qr = (t) => R(t, (e) => q(t, e, !1)), Xr = (t) => R(t, (e) => q(t, e, !S(t))), Yr = (t) => R(t, (e) => q(t, e, S(t))), Zr = (t) => R(t, (e) => d.cursor(t.lineBlockAt(e.head).from, 1)), eo = (t) => R(t, (e) => d.cursor(t.lineBlockAt(e.head).to, -1));
function to(t, e, r) {
  let n = !1, o = re(t.selection, (i) => {
    let s = Y(t, i.head, -1) || Y(t, i.head, 1) || i.head > 0 && Y(t, i.head - 1, 1) || i.head < t.doc.length && Y(t, i.head + 1, -1);
    if (!s || !s.end)
      return i;
    n = !0;
...
const ro = (t) => on(t, !S(t)), oo = (t) => on(t, S(t)), io = (t) => B(t, (e) => Ie(t.state, e, !S(t))), so = (t) => B(t, (e) => Ie(t.state, e, S(t)));
function sn(t, e) {
...
const ut = (t) => cn(t, !1), ft = (t) => cn(t, !0), lo = (t) => B(t, (e) => q(t, e, !0)), ao = (t) => B(t, (e) => q(t, e, !1)), co = (t) => B(t, (e) => q(t, e, !S(t))), ho = (t) => B(t, (e) => q(t, e, S(t))), uo = (t) => B(t, (e) => d.cursor(t.lineBlockAt(e.head).from)), fo = (t) => B(t, (e) => d.cursor(t.lineBlockAt(e.head).to)), dt = ({ state: t, dispatch: e }) => (e(O(t, { anchor: 0 })), !0), mt = ({ state: t, dispatch: e }) => (e(O(t, { anchor: t.doc.length })), !0), gt = ({ state: t, dispatch: e }) => (e(O(t, { anchor: t.selection.main.anchor, head: 0 })), !0), pt = ({ state: t, dispatch: e }) => (e(O(t, { anchor: t.selection.main.anchor, head: t.doc.length })), !0), mo = ({ state: t, dispatch: e }) => (e(t.update({ selection: { anchor: 0, head: t.doc.length }, userEvent: "select" })), !0), go = ({ state: t, dispatch: e }) => {
...
const hn = (t, e) => Oe(t, (r) => {
  ...
  return n;
}), dn = (t) => fn(t, !1), xo = (t) => fn(t, !0), mn = (t) => Oe(t, (e) => {
...
function yn(t) {
  return ({ state: e, dispatch: r }) => {
    ...
    let n = e.changeByRange((o) => {
      ...
      let c = new Tt(e, { simulateBreak: i, simulateDoubleBreak: !!a }), h = It(c, i);
      ...
      return a && u.push(Se(e, c.lineIndent(l.from, -1))), {
        changes: { from: i, to: s, insert: Ot.of(u) },
...
const wo = ({ state: t, dispatch: e }) => {
  ...
  { key: "Ctrl-p", run: Xt, shift: ln },
  { key: "Ctrl-n", run: Yt, shift: an },
  { key: "Ctrl-a", run: Zr, shift: uo },
  ...
  { mac: "Cmd-ArrowLeft", run: Xr, shift: co, preventDefault: !0 },
  { key: "ArrowRight", run: _t, shift: rn, preventDefault: !0 },
  { key: "Mod-ArrowRight", mac: "Alt-ArrowRight", run: Gr, shift: oo, preventDefault: !0 },
  { mac: "Cmd-ArrowRight", run: Yr, shift: ho, preventDefault: !0 },
  { key: "ArrowUp", run: Xt, shift: ln, preventDefault: !0 },
  { mac: "Cmd-ArrowUp", run: dt, shift: gt },
  { mac: "Ctrl-ArrowUp", run: ht, shift: ut },
  { key: "ArrowDown", run: Yt, shift: an, preventDefault: !0 },
...
].concat(/* @__PURE__ */ Ro.map((t) => ({ mac: t.key, run: t.run, shift: t.shift }))), Io = /* @__PURE__ */ [
  ...
  { key: "Mod-/", run: Ar },
  { key: "Alt-A", run: Lr }
].concat(To), Oo = { key: "Tab", run: xn, shift: kn };
function g() {
  var t = arguments[0];
...
class Z {
  ...
  static get(e, r, n) {
    ...
    if (o.from == r && o.to == n)
      return o;
    let { text: i, from: s } = o;
    return s > r && (i = e.sliceString(r, s) + i, s = r), o.to < n && (i += e.sliceString(o.to, n)), Ve.set(e, new Z(s, i)), new Z(r, i.slice(r - s, n - s));
  }
}
class vn {
  constructor(e, r, n, o, i) {
...
` : n == "r" ? "\r" : n == "t" ? "	" : "\\");
  ...
  */
  create() {
    return this.regexp ? new Xo(this) : new jo(this);
  }
  /**
  ...
  */
  getCursor(e, r = 0, n) {
    ...
    return n == null && (n = o.doc.length), this.regexp ? X(this, o, r, n) : Q(this, o, r, n);
  }
}
class Ln {
  constructor(e) {
...
class Xo extends Ln {
  nextMatch(e, r, n) {
    let o = X(this.spec, e, n, e.doc.length).next();
    return o.done && (o = X(this.spec, e, 0, r).next()), o.done ? null : o.value;
  }
  prevMatchInRange(e, r, n) {
    for (let o = 1; ; o++) {
      let i = Math.max(
  ...
  matchAll(e, r) {
    let n = X(this.spec, e, 0, e.doc.length), o = [];
    for (; !n.next().done; ) {
      if (o.length >= r)
        return null;
      o.push(n.value);
...
const ue = /* @__PURE__ */ w.define(), st = /* @__PURE__ */ w.define(), N = /* @__PURE__ */ we.define({
  create(t) {
    return new ze(Xe(t).create(), null);
  },
  update(t, e) {
    for (let r of e.effects)
      r.is(ue) ? t = new ze(r.value.create(), t.panel) : r.is(st) && (t = new ze(t.query, r.value ? lt : null));
    return t;
  },
...
const Yo = /* @__PURE__ */ y.mark({ class: "cm-searchMatch" }), Zo = /* @__PURE__ */ y.mark({ class: "cm-searchMatch cm-searchMatch-selected" }), ei = /* @__PURE__ */ Ft.fromClass(class {
  constructor(t) {
...
const En = (t) => {
  ...
  if (e && e.panel) {
    ...
    if (r && r != t.root.activeElement) {
      let n = Xe(t.state, e.query.spec);
      n.valid && t.dispatch({ effects: ue.of(n) }), r.focus(), r.select();
    }
  } else
    t.dispatch({ effects: [
      st.of(!0),
      e ? ue.of(Xe(t.state, e.query.spec)) : w.appendConfig.of(li)
    ] });
  return !0;
}, wn = (t) => {
  let e = t.state.field(N, !1);
  ...
  constructor(e) {
    ...
    let r = (o) => {
      if (o.keyCode == 27)
        ...
        let { diagnostic: i } = this.items[this.selectedIndex], s = On(i.actions);
...
var vt = function(e) {
  ...
  e.closeBracketsKeymap !== !1 && (n = n.concat(ir)), e.defaultKeymap !== !1 && (n = n.concat(Io)), e.searchKeymap !== !1 && (n = n.concat(oi)), e.historyKeymap !== !1 && (n = n.concat(Ur)), e.foldKeymap !== !1 && (n = n.concat(sr)), e.completionKeymap !== !1 && (n = n.concat(lr)), e.lintKeymap !== !1 && (n = n.concat(pi));
  var o = [];
  return e.lineNumbers !== !1 && o.push(ar()), e.highlightActiveLineGutter !== !1 && o.push(cr()), e.highlightSpecialChars !== !1 && o.push(hr()), e.history !== !1 && o.push(Or()), e.foldGutter !== !1 && o.push(ur()), e.drawSelection !== !1 && o.push(fr()), e.dropCursor !== !1 && o.push(dr()), e.allowMultipleSelections !== !1 && o.push(he.allowMultipleSelections.of(!0)), e.indentOnInput !== !1 && o.push(mr()), e.syntaxHighlighting !== !1 && o.push(Nt(Sr, {
    fallback: !0
...
const Si = "#e5c07b", At = "#e06c75", Ci = "#56b6c2", vi = "#ffffff", be = "#abb2bf", Ye = "#7d8799", Ai = "#61afef", Mi = "#98c379", Mt = "#d19a66", Li = "#c678dd", Di = "#21252b", Lt = "#2c313a", Dt = "#282c34", Ue = "#353a42", Bi = "#3E4451", Bt = "#528bff", Ei = /* @__PURE__ */ p.theme({
  "&": {
    color: be,
    backgroundColor: Dt
  },
...
var Ti = p.theme({
  ...
  switch (r && a.unshift(qt.of([Oo])), l && (typeof l == "boolean" ? a.unshift(vt()) : a.unshift(vt(l))), s && a.unshift(vr(s)), i) {
    case "light":
      a.push(Ti);
      break;
    case "dark":
  ...
  return s && typeof s == "function" && se.push(p.updateListener.of(s)), se = se.concat(l), F(() => {
    if (v && !_) {
      var E = {
        ...
        selection: r,
        extensions: se
      }, le = z ? he.fromJSON(z.json, E, z.fields) : he.create(E);
      if (j(le), !k) {
        var me = new p({
          state: le,
          parent: v,
...
const Ni = p.theme({
  ...
  const x = zn(), b = Rt(null), [T, $] = ke(100), [H, G] = Un.useState(null), { setFocusState: V } = $n(), K = (v) => {
    c == null || c(v), V(!0);
  }, ie = (v) => {
    h == null || h(v), V(!1);
  };
  ...
  return /* @__PURE__ */ W.jsxs(W.Fragment, { children: [
    ...
    H && /* @__PURE__ */ W.jsxs("div", { className: n === "full" ? "h-full" : "", style: { width: T }, children: [
      /* @__PURE__ */ W.jsx(
        Wn,
        {
          ref: m,
...
//# sourceMappingURL=CodeEditorView-73bd35b1.mjs.map
